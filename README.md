...
- Get this repository from zip folder provided to your local computer.
...
- Start the local server
  ...
  **Expected Output**
  ```bash
    App listening at port 8084
  ```

- Verify the server is working as expected by acessing http://localhost:8084/api/users with a broswer or a third party tool like [Postman](https://www.postman.com/)
